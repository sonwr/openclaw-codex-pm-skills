...
- `../../scripts/validate_web_qa_report.py --file <report.md> --require-qa-inventory-check-refs` (ensures every QA inventory claim maps back to explicit check ids for replay planning)
